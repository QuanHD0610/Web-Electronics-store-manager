...
<section class="may-giat">
    <div class="container mt-5">
        <div class="title-may-lanh d-flex">
            <p class="fs-4 fw-bold text-primary">Sản phẩm máy gặt</p>
            <div class="row ps-5">
                <nav class="nav h-4 pt-2">
                    <a href="#" class="text-decoration-none text-dark ps-2 ">Máy giặt</a>
                    <a href="#" class=" text-decoration-none text-dark ps-2 ">Máy giặt cao cấp</a>
                    <a href="#" class=" text-decoration-none text-dark ps-2 ">Hiện đại</a>
                    <a href="#" class=" text-decoration-none text-dark ps-2 ">Nhẹ nhàng</a>
                </nav>
            </div>
        </div>
        <div class="product-show d-flex align-content-start flex-wrap">
            ...
            foreach ($ds_dien_may as $item) {              
                if ($item['category_id'] == 3 && $count<10) { $count++; ?>
                    <div class="card  border-info border-2 d-flex justify-content-around">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <p class="card-text my-1" style="font-size: 13px;">Quà tặng trị giá <strong>12.600.000đ</strong> <?php echo $item['product_id'] ?>  </p>
        ...
        <div class="product-show  d-flex justify-content-center align-items-center">
            <div class="show-all text-center  mx-auto my-auto" style="height: 40px;">
                <div class="show-text bg-white " style="height: 35px; width:50rem  ;">
                    <a href="search.php?category_name=Máy giặt" class="bg-white text-primary fw-bold text-decoration-none" style="height: 30px;">xem
                        tất cả</a>
                </div>
            </div>
        </div>
