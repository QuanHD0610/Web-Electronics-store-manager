<section class="tu-lanh">
    <div class="container mt-5">
        <div class="title-may-lanh d-flex">
            <p class="fs-4 fw-bold text-primary">Sản phẩm tủ lạnh</p>
            <div class="row ps-5">
                <nav class="nav h-4 pt-2">
                    <a href="#" class="text-decoration-none text-dark ps-2 ">Tủ lạnh</a>
                    <a href="#" class=" text-decoration-none text-dark ps-2 ">Tủ lạnh cao cấp</a>
                    <a href="#" class=" text-decoration-none text-dark ps-2 ">Hiện đại</a>
                    <a href="#" class=" text-decoration-none text-dark ps-2 ">Tiết kiệm điện</a>
                </nav>
            </div>
        </div>
        ...
        <div class="product-show  d-flex justify-content-center align-items-center">
            <div class="show-all text-center  mx-auto my-auto" style="height: 40px;">
                <div class="show-text bg-white " style="height: 35px; width:50rem  ;">
                    <a href="search.php?category_name=Tủ lạnh" class="bg-white text-primary fw-bold text-decoration-none" style="height: 30px;">xem
                        tất cả</a>
                </div>
            </div>
        </div>
